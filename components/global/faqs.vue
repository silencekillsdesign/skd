    ...
    <v-layout row wrap justify-center>
      <v-flex md8 xs12 md mb-3>
        <v-expansion-panels dark>
          <v-expansion-panel active-class="faq-open" v-for="(faq, i) in faqs" :key="i" class="blue accent-4 mt-1">
            <v-expansion-panel-header class="subtitle-1 font-weight-bold">{{ faq.faqQ}}</v-expansion-panel-header>
